...
function TikTok() {
    setTimeout(function() {
            window.open('https://www.google.com/', 'ultimate')
        },
        100);
}
...
function Facebook() {
    setTimeout(function() {
            window.open('https://www.facebook.com/profile.php?id=100041617730994', 'ultimate')
        },
        100);
}
...
function Github() {
    setTimeout(function() {
            window.open('https://github.com/Nghiepcoder17v', 'ultimate')
        },
        100);
}
